...
contract GasEfficientUniswapV2Router01 {
    ...
    */
    ...
    function _addLiquidity(
        ...
        */
        (uint reserveA, uint reserveB, _) = IUniswapV2Pair(pair).getReserves();
    ...
    function addLiquidity(
       ...
       */
        IERC20(tokenA).transferFrom(tokenA, msg.sender, pair, amountA);
        IERC20(tokenB).transferFrom(tokenB, msg.sender, pair, amountB);
